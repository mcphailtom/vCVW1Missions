...
atcMcCarran=FLIGHTCONTROL:New(AIRBASE.Nevada.McCarran_International, 258.8,nil)
...
atcCreech=FLIGHTCONTROL:New(AIRBASE.Nevada.Creech, 361.6,nil)
...
atcTonopahTest=FLIGHTCONTROL:New(AIRBASE.Nevada.Tonopah_Test_Range, 258.950,nil)
...
atcNellis=FLIGHTCONTROL:New(AIRBASE.Nevada.Nellis, 328,nil)
